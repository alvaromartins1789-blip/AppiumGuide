...
/**
 * Script Details - This class is created to demo - How to Start & Stop Server Programmatically "By Using ‘AppiumServiceBuilder’ & ‘AppiumDriverLocalService’ Classes"
 * 
...
public class SampleForStartServer_Demo2 {
	...
	public void setup() throws MalformedURLException, InterruptedException {
		//Calling startserver method to start appium server
		System.out.println("Calling startserver method to start appium server");
		StartSeverByUsingClasses.startServer();
	...
	public void teardown() {
		...
		if(driver!=null) {
			driver.quit();
			//Stop appium server
			StartSeverByUsingClasses.stopServer();
