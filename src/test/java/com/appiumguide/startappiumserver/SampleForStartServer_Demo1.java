...
/**
 * Script Details - This class is created to demo - How to Start & Stop Server Programmatically "By Using main.js(Appium.js) with Node.exe"
 * 
...
public class SampleForStartServer_Demo1 {
	...
	public void setup() throws MalformedURLException, InterruptedException {
		...
		StartServerByUsingmainjs.startServer();
		Thread.sleep(5000);
	...
	public void teardown() {
		...
		if(driver!=null) {
			...
			StartServerByUsingmainjs.stopServer();
