...
/**
 * Script Details - This class is created to demo - How to Start & Stop Server Programmatically By using "By Using Java Runtime() to invoke through cmd"
 * 
...
public class SampleForStartServer_Demo {
	...
	public void setup() throws MalformedURLException, InterruptedException {
		//Calling StartServer Method
		System.out.println("Calling StartServer Method");
		StartServerByUsingcmd.startServer();
		Thread.sleep(5000);
	...
	public void teardown() {
		...
		if(driver!=null) {
			driver.quit();
			//Calling StopServer Method
			System.out.println("Calling StopServer Method");
			StartServerByUsingcmd.stopServer();
